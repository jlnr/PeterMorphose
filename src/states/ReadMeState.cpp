...
void ReadMeState::draw()
{
    ...
    case 5:
        ...
        stretch_draw(object_image(static_cast<PMID>(ID_POINTS + 4)), 5, 315);
        stretch_draw(object_image(static_cast<PMID>(ID_POINTS + 1)), 25, 290);
        stretch_draw(object_image(static_cast<PMID>(ID_POINTS + 3)), 15, 300);
        stretch_draw(object_image(static_cast<PMID>(ID_POINTS + 2)), 20, 310);

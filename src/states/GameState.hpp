...
public:
    ...
    /// Runs a PMScript: a backslash-separated list of commands, each prefixed with the relevant
    /// trigger name (e.g. "lava", "player", "do") and optional conditions.
...
private:
    ...
    PMScript m_script;
    /// The highest tile rows the lava and the player have reached (for firing PMScripts).

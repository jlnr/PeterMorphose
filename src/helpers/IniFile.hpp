...
public:
    ...
    /// Returns the value for the given key, converted from CP1252 to UTF-8, or std::nullopt.
    ...
    /// Sets a raw (CP1252) value, creating the section and key if necessary.
...
private:
    /// Values are stored internally in their original encoding (binary or CP1252).

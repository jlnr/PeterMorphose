...
const Gosu::Image& tile_image(TileID tile)
{
    static const std::vector<Gosu::Image> images
        = Gosu::load_tiles("media/Tiles.png", TILE_SIZE, TILE_SIZE, Gosu::IF_RETRO);
...
{
    static const std::vector<Gosu::Image> images
        = Gosu::load_tiles("media/Effects.png", -7, -7, Gosu::IF_SMOOTH);
